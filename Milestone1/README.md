...
Add the required secrets in Colab → Secrets:
...
Open the generated ngrok URL in a web browser to use the portal.
...
Protected pages are accessible only while the JWT token remains valid.
ngrok Integration
